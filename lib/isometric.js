...
(function (global) {
  ...
  var cube_default_settings = {
    'perspective': 800,
  }

  var isometric = {
    cube: function (wrap_id, obj = cube_default_settings) {
      obj = $.extend(cube_default_settings, obj)
      function load_cube_style(){
        console.log(obj['perspective']);
        $(".viewport").css({})
      }

      // general
      var el = $(wrap_id)
      var viewport = el.append('\
        <div class="viewport">\
          <div class="cube">\
            <div class="side">\
